...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
    ({ className, ...props }, ref) => (
        <div
            ref={ref}
            className={cnLite("rounded-lg border border-dark-border bg-dark-card text-dark-card-foreground shadow-sm", className)}
            {...props}
        />
    )
);
...
const CardDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
    ({ className, ...props }, ref) => (
        <p ref={ref} className={cnLite("text-sm text-dark-muted-foreground", className)} {...props} />
    )
);
